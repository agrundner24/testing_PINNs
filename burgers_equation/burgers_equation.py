...
class PhysicsInformedNN:
    ...
    def __init__(self, x, y, t, u, layers):
        ...
        self.c1 = tf.Variable([0], dtype=tf.float32)
        self.c2 = tf.Variable([0], dtype=tf.float32)
    ...
    def net_NS(self, x, y, t):
        ...
        f_u = u_t - c0*u + c1*u_x*u + c2*u_y*u - c20*u_xx - c02*u_yy - c11*u_xy - c30*u_xxx - c21*u_xxy - c12*u_xyy \
              - c03*u_yyy
        
        return u, f_u
    
    def callback(self, loss, c0, c1, c2, c20, c11, c02, c30, c21, c12, c03):
        print('Loss: %.3e, c0:%.5f, c1:%.5f, c2:%.5f, c20:%.5f, c11:%.5f, c02:%.5f, c30:%.5f, c21:%.5f, '
              'c12:%.5f, c03:%.5f' % (loss, c0, c1, c2, c20, c11, c02, c30, c21, c12, c03))
    ...
    def train(self, nIter): 
        ...
        for it in range(nIter):
            ...
            if it % 10 == 0:
                ...
                c2_value = self.sess.run(self.c2)
                ...
                print('It: %d, Loss: %.3e, c0:%.5f, c1:%.5f, c2:%.5f, c20:%.5f, c11:%.5f, c02:%.5f, '
                      'c30:%.5f, c21:%.5f, c12:%.5f, c03:%.5f, Time: %.2f' %
                      (it, loss_value, c0_value, c1_value, c2_value, c20_value, c11_value, c02_value,
                       c30_value, c21_value, c12_value, c03_value, elapsed))
                start_time = time.time()
            
        self.optimizer.minimize(self.sess,
                                feed_dict = tf_dict,
                                fetches = [self.loss, self.c0, self.c1, self.c2, self.c20, self.c11,
...
def plot_solution(X_star, u_star, index, isPred):
    ...
    if isPred is True:
        plt.savefig('./Burgers_prediction_%d' % index)
    else:
        plt.savefig('./Burgers_%d' % index)
...
if __name__ == "__main__": 
    ...
    N_train = 15000  # Have 540.000 data points over in PDE-Net
    ...
    c1_value = model.sess.run(model.c1)
    c2_value = model.sess.run(model.c2)
    ...
    error_c0 = (c0_value - 0)**2
    error_c1 = (c1_value - 1) ** 2
    error_c2 = (c2_value - 1) ** 2
    ...
    print('Error c1: %.5f' % (error_c1))
    print('Error c2: %.5f' % (error_c2))
    ...
    with open('results.txt', 'a') as file:
        ...
        file.write('Inferred c1: %.5f\n' % (c1_value))
        file.write('Inferred c2: %.5f\n' % (c2_value))
        ...
        file.write('Squared error c1: %.5f\n' % (error_c1))
        file.write('Squared error c2: %.5f\n' % (error_c2))
